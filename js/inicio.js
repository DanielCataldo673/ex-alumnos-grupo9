...
function startPresentation() {  
    ...
    setTimeout(() => {  
        ...
        setTimeout(() => {  
            ...
            // Ocultar la sección star-wars después de 150 segundos y volver a la pantalla de inicio  
            setTimeout(() => {  
                audio.pause();  
            ...
            }, 50000); // Mostrar star-wars durante 150 segundos  
...
document.addEventListener('DOMContentLoaded', () => {  
    ...
    presentacionBtn.addEventListener('click', startPresentation);  
});